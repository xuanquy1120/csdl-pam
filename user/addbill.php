      ...
      <div id="content">
        ...
        <input  type="hidden" name="userid" value="<?php echo "".$_SESSION['userid'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control"  type="text" name="customer_sendname" id="customerSendname" placeholder="Nhập tên người gửi">
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" name="status" value="Đã Thanh toán xong" id="datereceived">Đã Thanh toán xong
                        <input type="radio" name="status" value="Chưa thanh toán xong" id="datereceived">Chưa thanh toán xong</p>  
                    </div>  
                    <div class="form-group">
                        <label>Tiền đã thanh toán: </label>
                        <input class="form-control"  type="number" name="pay" id="pay" placeholder="Nhập tiền">   
