...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Thống kê</h1>
  ...
  <td><strong><?php echo $total_fee; ?> VNĐ</strong></td>
       <td><strong><?php echo $total_pay; ?> VNĐ</strong></td>
       <td><strong><?php echo $total_unpaid; ?> VNĐ</strong></td>
   </tr>
